...
@implementation DLSponsoringBanerModule

static dispatch_once_t once;
static DLSponsoringBanerModule* sharedInstance;

+ (instancetype)initializeWithSite:(NSString *)site area:(NSString *)area
{
    return [DLSponsoringBanerModule initializeWithSite:site
                                         area:area
...
{
    for (id<DLSponsoringBanerModuleDelegate> delegate in self.delegates) {
