...
@interface DLAdView() <DLSponsoringBanerModuleDelegate>
@property (nonatomic, weak) DLSponsoringBanerModule *splashModule;
...
{
    self.displayed = NO;
    self.splashModule = DLSponsoringBanerModule.sharedInstance;
...
- (void)displayAd
{
    self.splashAd = DLSponsoringBanerModule.sharedInstance.splashAd;
...
#pragma mark - DLSponsoringBanerModuleDelegate
