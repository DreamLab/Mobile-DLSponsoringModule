//
//  DLSponsoringBanerModuleTests.m
//  DLSponsoringBanerModuleTests
//
...
@interface DLSponsoringBanerModule ()
...
@interface DLSponsoringBanerModuleTests : XCTestCase

@property (nonatomic, strong) id store;
@property (nonatomic, strong) DLSplashScreenWebService *webService;
@property (nonatomic, strong) DLSponsoringBanerModule *splashModule;
@property (nonatomic, strong) id delegate;
@end

@implementation DLSponsoringBanerModuleTests
...
- (void)setUp {
    ...
    self.splashModule = [[DLSponsoringBanerModule alloc] init];
    id delegate = OCMProtocolMock(@protocol(DLSponsoringBanerModuleDelegate));
