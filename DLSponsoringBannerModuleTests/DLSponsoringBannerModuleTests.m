...
//    OCMStub([self.webService fetchDataWithCompletion:([OCMArg invokeBlockWithArgs:OCMClassMock([DLSponsoringBannerAd class]), [NSNull null], nil])]);
...
//{
//    DLSponsoringBannerAd *splashAd = OCMClassMock([DLSponsoringBannerAd class]);
